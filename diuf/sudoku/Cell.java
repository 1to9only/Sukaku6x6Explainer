...
public class Cell {
     ...
     * @param x the x coordinate of this cell (0=leftmost, 5=rightmost)
     * @param y the y coordinate of this cell (0=topmost, 5=bottommost)
     */
...
//a     assert value != 0;
     ...
     * bit number 1 to 6 is set if the corresponding
     ...
     * value for this cell.
     * @param value the potential value to test, between 1 and 6, inclusive
     ...
     * @param value the value to add, between 1 and 6, inclusive
     */
     ...
     * @param value the value to remove, between 1 and 6, inclusive
     */
     ...
     * @param x the horizontal coordinate of the cell (0=leftmost, 5=rightmost)
     * @param y the vertical coordinate of the cell (0=topmost, 5=bottommost)
